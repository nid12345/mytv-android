...
object HttpServer : Loggable() {
            ...
            send(
                json.encodeToString(
                    AllSettings(
                        ...
                        iptvChaoshanSourceEnable = Configs.iptvChaoshanSourceEnable,
                        iptvVodAutoPlayNextEnable = Configs.iptvVodAutoPlayNextEnable,
                        updateRemindEnable = Configs.updateRemindEnable,
                        updateForceRemind = Configs.updateForceRemind,
                        updateChannel = Configs.updateChannel,
                        updateDownloadRoute = Configs.updateDownloadRoute,
    ...
    private fun handleConfigsPush(
        ...
        Configs.iptvChaoshanSourceEnable = configs.iptvChaoshanSourceEnable
        Configs.iptvVodAutoPlayNextEnable = configs.iptvVodAutoPlayNextEnable
        Configs.updateRemindEnable = configs.updateRemindEnable
        Configs.updateForceRemind = configs.updateForceRemind
        Configs.updateChannel = configs.updateChannel
        Configs.updateDownloadRoute = configs.updateDownloadRoute
...
private data class AllSettings(
    ...
    val iptvChaoshanSourceEnable: Boolean = false,
    val iptvVodAutoPlayNextEnable: Boolean = true,
    val updateRemindEnable: Boolean = true,
    val updateForceRemind: Boolean = false,
    val updateChannel: String = "",
    val updateDownloadRoute: Configs.UpdateDownloadRoute = Configs.UpdateDownloadRoute.AUTO,
